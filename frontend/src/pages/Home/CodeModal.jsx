...
const CodeModal = ({ code, onClose }) => {
  return (
    <div className="fixed bg-black bg-opacity-70  top-0 left-0 right-0 bottom-0 z-50 flex justify-center items-center">
      <div
        onClick={(event) => event.stopPropagation()}
        className="w-[600px] max-w-full  mx-7 md:mx-0 font-fontfamily5 text-blue-950 bg-white rounded-xl p-4 flex flex-col relative"
      >
        <AiOutlineClose
          className="absolute right-6 top-6 text-3xl text-gray-800 cursor-pointer"
          onClick={onClose}
        />
        ...
        <div className="my-2">
          <span className=" mr-3 text-blue-950 font-semibold">Created At:</span>
