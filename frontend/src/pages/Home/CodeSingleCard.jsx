...
const CodeSingleCard = ({ code }) => {
  ...
  return (
    <div
      key={code._id}
      className="border-[0.5px] shadow-lg bg-[#00072d] text-gray-600 dark:bg-blue-200  shadow-slate-500 font-fontfamily5 border-gray-800  rounded-lg px-4 py-2 m-4 relative "
    >
